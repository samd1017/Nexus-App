...
var LogicalSize = class {
	constructor(...args) {
		this.type = "Logical";
		if (args.length === 1) if ("Logical" in args[0]) {
...
var PhysicalSize = class {
	constructor(...args) {
		this.type = "Physical";
		if (args.length === 1) if ("Physical" in args[0]) {
...
var window_exports = /* @__PURE__ */ __exportAll({
...
var Window = class {
	...
	*/
	async requestUserAttention(requestType) {
		...
		if (requestType) if (requestType === UserAttentionType.Critical) requestType_ = { type: "Critical" };
...
//#endregion
export { invoke as a, core_exports as i, event_exports as n, Resource as r, window_exports as t };
