import { A as parseIndentedBlocks, C as isNodeActive, K as Fragment, N as wrappingInputRule, O as mergeAttributes, R as Plugin, S as isAtStartOfNode, b as getRenderedAttributes, j as renderNestedMarkdownContent, o as Node3, r as Extension, v as getNodeAtPosition, x as isAtEndOfNode, y as getNodeType } from "./core+[...].mjs";
...
function isBlockContentLine(line) {
	...
	return PARAGRAPH_INTERRUPTERS.bulletItem.test(trimmedLine) || isOrderedListMarkerLine(trimmedLine) || PARAGRAPH_INTERRUPTERS.heading.test(trimmedLine) || PARAGRAPH_INTERRUPTERS.thematicBreak.test(trimmedLine) && !trimmedLine.startsWith("-") || /^>\s?/.test(trimmedLine) || PARAGRAPH_INTERRUPTERS.codeFence.test(trimmedLine);
}
...
//#endregion
export { OrderedList as a, ListKeymap as i, BulletList as n, TaskItem as o, ListItem as r, TaskList as s, index_default as t };
