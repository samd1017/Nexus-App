import { B as Selection, F as Decoration, H as TextSelection, I as DecorationSet, K as Fragment, L as NodeSelection, O as mergeAttributes, P as keydownHandler, R as Plugin, V as SelectionRange, W as Transform, g as getExtensionField, l as callOrReturn, o as Node3, p as findParentNodeClosestToPos, q as Slice, r as Extension, z as PluginKey } from "./core+[...].mjs";
...
var TableView = class {
	constructor(node, cellMinWidth, _view, HTMLAttributes = {}) {
		...
		this.dom.className = "tableWrapper";
		this.table = this.dom.appendChild(document.createElement("table"));
		for (const [key, value] of Object.entries(HTMLAttributes)) if (value !== void 0 && value !== null) if (key === "style") this.table.style.cssText = String(value);
