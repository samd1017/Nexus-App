import { _ as Sprite, a as CanvasTexture, m as SRGBColorSpace, v as SpriteMaterial } from "./3d-force-graph+[...].mjs";
//#region node_modules/three-spritetext/dist/three-spritetext.mjs
	...
	return _createClass(_default, [
		...
		},
		{
			...
			value: function _genCanvas() {
				...
				var relBorderRadius = (Array.isArray(this.borderRadius) ? this.borderRadius : [
					this.borderRadius,
					this.borderRadius,
					this.borderRadius,
					this.borderRadius
				...
				if (this.borderWidth) {
					...
					if (this.borderRadius) {
						...
						[
							...
							!!relBorderRadius[1] && [
								boxWidth - relBorderRadius[1],
								boxWidth - _hb2,
								_hb2,
								relBorderRadius[1]
							],
							!!relBorderRadius[2] && [
								boxWidth - relBorderRadius[2],
								boxWidth - _hb2,
								boxHeight - _hb2,
								boxHeight - relBorderRadius[2]
							],
							!!relBorderRadius[3] && [
								relBorderRadius[3],
								_hb2,
								boxHeight - _hb2,
								boxHeight - relBorderRadius[3]
							]
						].filter(function(d) {
							return d;
				...
				if (this.backgroundColor) {
					...
					if (!this.borderRadius) ctx.fillRect(relBorder[0], relBorder[1], boxWidth - relBorder[0] * 2, boxHeight - relBorder[1] * 2);
					else {
						ctx.beginPath();
