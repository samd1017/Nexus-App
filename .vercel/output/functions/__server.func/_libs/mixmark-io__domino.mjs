...
var require_Event = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function Event(type, dictionary) {
		...
		if (dictionary) for (var p in dictionary) this[p] = dictionary[p];
	}
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/UIEvent.js
var require_UIEvent = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/MouseEvent.js
var require_MouseEvent = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/DOMException.js
var require_DOMException = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/config.js
var require_config = /* @__PURE__ */ __commonJSMin(((exports) => {
	exports.isApiWritable = !globalThis.__domino_frozen__;
}));
//#endregion
//#region node_modules/@mixmark-io/domino/lib/utils.js
var require_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.expose = function(src, c) {
		for (var n in src) Object.defineProperty(c.prototype, n, {
			value: src[n],
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/EventTarget.js
var require_EventTarget = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	EventTarget.prototype = {
		...
		removeEventListener: function removeEventListener(type, listener, capture) {
			...
			if (this._listeners) {
				var list = this._listeners[type];
				if (list) for (var i = 0, n = list.length; i < n; i++) {
					var l = list[i];
					if (l.listener === listener && l.capture === capture) {
						if (list.length === 1) this._listeners[type] = void 0;
		...
		_dispatchEvent: function _dispatchEvent(event, trusted) {
			...
			function invoke(target, event) {
				...
				if (phase !== Event.CAPTURING_PHASE && target._handlers && target._handlers[type]) {
					...
					var rv;
					if (typeof handler === "function") rv = handler.call(event.currentTarget, event);
					else {
					...
					switch (event.type) {
						case "mouseover":
							...
							break;
						default: if (rv === false) event.preventDefault();
					}
				}
				...
				for (var i = 0, n = list.length; i < n; i++) {
					...
					if (l.f) l.f.call(event.currentTarget, event);
					else {
			...
			if (trusted && !event.defaultPrevented && event instanceof MouseEvent) switch (event.type) {
				case "mousedown":
					this._armed = {
						x: event.clientX,
						y: event.clientY,
		...
		_doClick: function(event) {
			...
			if (activated && activated._pre_click_activation_steps) activated._pre_click_activation_steps();
			...
			if (activated) {
				...
				} else if (activated._cancelled_activation_steps) activated._cancelled_activation_steps();
			}
		},
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/LinkedList.js
var require_LinkedList = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var utils = require_utils();
	var LinkedList = module.exports = {
		...
		replace: function(a, b) {
			...
			if (b !== null) LinkedList.insertBefore(b, a);
			LinkedList.remove(a);
			utils.assert(LinkedList.valid(a) && (b === null || LinkedList.valid(b)));
		},
		remove: function(a) {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NodeUtils.js
var require_NodeUtils = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		serializeOne,
	...
	function escape(s) {
		if (!ESCAPE_REGEXP.test(s)) return s;
	...
	function escapeAttr(s) {
		if (!ESCAPE_ATTR_REGEXP.test(s)) return s;
	...
	function attrname(a) {
		...
		if (ns === NAMESPACE.XMLNS) if (a.localName === "xmlns") return "xmlns";
	...
	*/
	function escapeMatchingClosingTag(rawText, parentTag) {
		...
		if (!rawText.toLowerCase().includes(parentClosingTag)) return rawText;
		const result = [...rawText];
		const matches = rawText.matchAll(new RegExp(parentClosingTag, "ig"));
		for (const match of matches) result[match.index] = "&lt;";
		return result.join("");
	}
	...
	*/
	function escapeClosingCommentTag(rawContent) {
		if (!CLOSING_COMMENT_REGEXP.test(rawContent)) return rawContent;
		...
		switch (kid.nodeType) {
			case 1:
				...
				if (!(html && emptyElements[tagname])) {
					...
					if (hasRawContent[tagname.toUpperCase()]) ss = escapeMatchingClosingTag(ss, tagname);
			...
			case 4:
				...
				if (hasRawContent[parenttag] || parenttag === "NOSCRIPT" && parent.ownerDocument._scripting_enabled) s += kid.data;
				else s += escape(kid.data);
				break;
			case 8:
			...
			case 10:
				...
				s += ">";
				break;
			default: utils.InvalidStateError();
		}
		return s;
	}
}));
//#endregion
//#region node_modules/@mixmark-io/domino/lib/Node.js
	...
	Node.prototype = Object.create(EventTarget.prototype, {
		...
		isConnected: { get: function() {
			...
			while (node != null) {
				...
				if (node != null && node.nodeType === Node.DOCUMENT_FRAGMENT_NODE) node = node.host;
			}
			return false;
		} },
		...
		_countChildrenOfType: { value: function(type) {
			var sum = 0;
			for (var kid = this.firstChild; kid !== null; kid = kid.nextSibling) if (kid.nodeType === type) sum++;
			return sum;
		} },
		_ensureInsertValid: { value: function _ensureInsertValid(node, child, isPreinsert) {
			...
			if (parent.nodeType === DOCUMENT_NODE) switch (node.nodeType) {
				case TEXT_NODE:
					...
					switch (node._countChildrenOfType(ELEMENT_NODE)) {
						...
						case 1:
							if (child !== null) {
								...
								for (kid = child.nextSibling; kid !== null; kid = kid.nextSibling) if (kid.nodeType === DOCUMENT_TYPE_NODE) utils.HierarchyRequestError();
							}
							i = parent._countChildrenOfType(ELEMENT_NODE);
							if (isPreinsert) {
								if (i > 0) utils.HierarchyRequestError();
							} else if (i > 1 || i === 1 && child.nodeType !== ELEMENT_NODE) utils.HierarchyRequestError();
							break;
						default: utils.HierarchyRequestError();
					}
					break;
				...
				case DOCUMENT_TYPE_NODE:
					...
					} else for (kid = parent.firstChild; kid !== null; kid = kid.nextSibling) {
						if (kid === child) break;
					...
					if (isPreinsert) {
						if (i > 0) utils.HierarchyRequestError();
					} else if (i > 1 || i === 1 && child.nodeType !== DOCUMENT_TYPE_NODE) utils.HierarchyRequestError();
			}
			else if (node.nodeType === DOCUMENT_TYPE_NODE) utils.HierarchyRequestError();
		} },
		...
		replaceChild: { value: function replaceChild(node, child) {
			...
			if (node.doc !== parent.doc) parent.doc.adoptNode(node);
		...
		compareDocumentPosition: { value: function compareDocumentPosition(that) {
			...
			for (var i = 1; i < n; i++) if (these[i] !== those[i]) if (these[i].index < those[i].index) return DOCUMENT_POSITION_FOLLOWING;
		...
		isEqualNode: { value: function isEqualNode(node) {
			...
			for (var c1 = this.firstChild, c2 = node.firstChild; c1 && c2; c1 = c1.nextSibling, c2 = c2.nextSibling) if (!c1.isEqualNode(c2)) return false;
			return c1 === null && c2 === null;
		} },
		cloneNode: { value: function(deep) {
			var clone = this.clone();
			if (deep) for (var kid = this.firstChild; kid !== null; kid = kid.nextSibling) clone._appendChild(kid.cloneNode(true));
			return clone;
		} },
		lookupPrefix: { value: function lookupPrefix(ns) {
			...
			switch (this.nodeType) {
				case ELEMENT_NODE: return this._lookupNamespacePrefix(ns, this);
				case DOCUMENT_NODE:
				...
				case NOTATION_NODE:
				case DOCUMENT_FRAGMENT_NODE:
				case DOCUMENT_TYPE_NODE: return null;
				case ATTRIBUTE_NODE:
					e = this.ownerElement;
					return e ? e.lookupPrefix(ns) : null;
				default:
		...
		lookupNamespaceURI: { value: function lookupNamespaceURI(prefix) {
			if (prefix === "" || prefix === void 0) prefix = null;
			var e;
			switch (this.nodeType) {
				case ELEMENT_NODE: return utils.shouldOverride();
				case DOCUMENT_NODE:
					e = this.documentElement;
				...
				case NOTATION_NODE:
				case DOCUMENT_TYPE_NODE:
				case DOCUMENT_FRAGMENT_NODE: return null;
				case ATTRIBUTE_NODE:
					e = this.ownerElement;
					return e ? e.lookupNamespaceURI(prefix) : null;
				default:
		...
		index: { get: function() {
			...
			if (this._index === void 0 || kids[this._index] !== this) {
				for (var i = 0; i < kids.length; i++) kids[i]._index = i;
		...
		isAncestor: { value: function(that) {
			...
			for (var e = that; e; e = e.parentNode) if (e === this) return true;
			return false;
		} },
		ensureSameDoc: { value: function(that) {
			if (that.ownerDocument === null) that.ownerDocument = this.doc;
			else if (that.ownerDocument !== this.doc) utils.WrongDocumentError();
		} },
		removeChildren: { value: utils.shouldOverride },
		_insertOrReplace: { value: function _insertOrReplace(parent, before, isReplace) {
			var child = this, before_index, i;
			if (child.nodeType === DOCUMENT_FRAGMENT_NODE && child.rooted) utils.HierarchyRequestError();
			if (parent._childNodes) {
				before_index = before === null ? parent._childNodes.length : before.index;
				if (child.parentNode === parent) {
					if (child.index < before_index) before_index--;
				}
			}
			if (isReplace) {
			...
			if (child.nodeType === DOCUMENT_FRAGMENT_NODE) {
				...
				if (isReplace) LinkedList.replace(n, len > 2 ? spliceArgs[2] : null);
				else if (len > 2 && n !== null) LinkedList.insertBefore(spliceArgs[2], n);
				if (parent._childNodes) {
					spliceArgs[0] = before === null ? parent._childNodes.length : before._index;
					parent._childNodes.splice.apply(parent._childNodes, spliceArgs);
					for (i = 2; i < len; i++) spliceArgs[i]._index = spliceArgs[0] + (i - 2);
				} else if (parent._firstChild === before) {
					if (len > 2) parent._firstChild = spliceArgs[2];
					else if (isReplace) parent._firstChild = null;
				}
				if (child._childNodes) child._childNodes.length = 0;
				else child._firstChild = null;
				if (parent.rooted) {
					parent.modify();
					for (i = 2; i < len; i++) parent.doc.mutateInsert(spliceArgs[i]);
				}
			} else {
				if (before === child) return;
				if (bothRooted) child._remove();
				else if (child.parentNode) child.remove();
				...
				if (isReplace) {
					...
					} else if (parent._firstChild === before) parent._firstChild = child;
				} else {
					if (n !== null) LinkedList.insertBefore(child, n);
					if (parent._childNodes) {
						child._index = before_index;
		...
		modify: { value: function() {
			if (this.doc.modclock) {
				...
				for (var n = this; n; n = n.parentElement) if (n._lastModTime) n._lastModTime = time;
			}
		} },
		doc: { get: function() {
		...
		serialize: { value: function() {
			...
			var s = "";
			for (var kid = this.firstChild; kid !== null; kid = kid.nextSibling) s += NodeUtils.serializeOne(kid, this);
			return s;
		} },
		outerHTML: {
			get: function() {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NodeList.es6.js
var require_NodeList_es6 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = class NodeList extends Array {
		constructor(a) {
			super(a && a.length || 0);
			if (a) for (var idx in a) this[idx] = a[idx];
		}
		item(i) {
			return this[i] || null;
		}
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NodeList.es5.js
var require_NodeList_es5 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	function item(i) {
		return this[i] || null;
	}
	function NodeList(a) {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NodeList.js
var require_NodeList = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var NodeList;
	try {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/ContainerNode.js
var require_ContainerNode = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	ContainerNode.prototype = Object.create(Node.prototype, {
		...
		lastChild: { get: function() {
			...
			if (kids) return kids.length === 0 ? null : kids[kids.length - 1];
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/xmlnames.js
var require_xmlnames = /* @__PURE__ */ __commonJSMin(((exports) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/attributes.js
var require_attributes = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.property = function(attr) {
		if (Array.isArray(attr.type)) {
			...
			if (missingValueDefault === void 0) missingValueDefault = null;
			var invalidValueDefault = attr.invalid;
			if (invalidValueDefault === void 0) invalidValueDefault = missingValueDefault;
			return {
				get: function() {
		...
		} else if (attr.type === Boolean) return {
			get: function() {
				return this.hasAttribute(attr.name);
			},
			set: function(v) {
				if (v) this._setattr(attr.name, "");
				else this.removeAttribute(attr.name);
			}
		};
		else if (attr.type === Number || attr.type === "long" || attr.type === "unsigned long" || attr.type === "limited unsigned long with fallback") return numberPropDesc(attr);
		else if (!attr.type || attr.type === String) return {
			get: function() {
		...
		else if (typeof attr.type === "function") return attr.type(attr.name, attr);
		throw new Error("Invalid attribute definition");
	};
	function numberPropDesc(a) {
		var def;
		if (typeof a.default === "function") def = a.default;
		else if (typeof a.default === "number") def = function() {
			return a.default;
		};
		else def = function() {
		...
		return {
			get: function() {
				...
				if (v === null || !isFinite(n) || min !== void 0 && n < min || max !== void 0 && n > max) return def.call(this);
			...
			set: function(v) {
				...
				if (setmin !== void 0 && v < setmin) utils.IndexSizeError(a.name + " set to " + v);
				if (unsigned_long) v = v < 0 || v > 2147483647 ? def.call(this) : v | 0;
				else if (unsigned_fallback) v = v < 1 || v > 2147483647 ? def.call(this) : v | 0;
				else if (signed_long) v = v < -2147483648 || v > 2147483647 ? def.call(this) : v | 0;
	...
	exports.registerChangeHandler = function(c, name, handler) {
		var p = c.prototype;
		if (!Object.prototype.hasOwnProperty.call(p, "_attributeChangeHandlers")) p._attributeChangeHandlers = Object.create(p._attributeChangeHandlers || null);
		p._attributeChangeHandlers[name] = handler;
	};
}));
//#endregion
//#region node_modules/@mixmark-io/domino/lib/FilteredElementList.js
var require_FilteredElementList = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	FilteredElementList.prototype = Object.create(Object.prototype, {
		...
		item: { value: function(n) {
			this.checkcache();
			if (!this.done && n >= this.cache.length) this.traverse();
			return this.cache[n];
		} },
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/DOMTokenList.js
var require_DOMTokenList = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var utils = require_utils();
	...
	Object.defineProperties(DOMTokenList.prototype, {
		...
		_update: { value: function(list) {
			...
			} else fixIndex(this, getList(this));
	...
	function fixIndex(clist, list) {
		...
		for (i = 0; i < list.length; i++) clist[i] = list[i];
		for (; i < oldLength; i++) clist[i] = void 0;
	}
	function handleErrors(token) {
		token = String(token);
		if (token === "") utils.SyntaxError();
		if (/[ \t\r\n\f]/.test(token)) utils.InvalidCharacterError();
		return token;
	}
	function toArray(clist) {
		var length = clist._length;
		var arr = Array(length);
		for (var i = 0; i < length; i++) arr[i] = clist[i];
		return arr;
	}
	function getList(clist) {
		var strProp = clist._getString();
		if (strProp === clist._lastStringValue) return toArray(clist);
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/select.js
var require_select = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var lastChild = function(el) {
		if (el = el.lastChild) while (el.nodeType !== 1 && (el = el.previousSibling));
		return el;
	};
	...
	var unquote = function(str) {
		...
		var ch = str[0];
		if (ch === "\"" || ch === "'") {
			if (str[str.length - 1] === ch) str = str.slice(1, -1);
		...
		} else if (rules.ident.test(str)) return decodeid(str);
		else return str;
	};
	...
	*/
	var parseNth = function(param_, test) {
		...
		if (param === "even") param = "2n+0";
		else if (param === "odd") param = "2n+1";
		else if (param.indexOf("n") === -1) param = "0n" + param;
	...
	*/
	var selectors = {
		...
		"attr": function(key, op, val, i) {
			...
			return function(el) {
				...
				switch (key) {
					...
					case "class":
						attr = el.className;
						if (attr === "" && el.getAttribute("class") == null) attr = null;
						break;
					case "href":
					case "src":
					...
					case "hidden":
					case "tabIndex":
					case "style": if (el.getAttribute) {
						attr = el.getAttribute(key);
						break;
					}
					default:
						if (el.hasAttribute && !el.hasAttribute(key)) break;
		...
		":first-of-type": function(el) {
			...
			while (el = prev(el)) if (el.nodeName === type) return;
			return true;
		},
		":last-of-type": function(el) {
			if (!parentIsElement(el)) return;
			var type = el.nodeName;
			while (el = next(el)) if (el.nodeName === type) return;
			return true;
		},
		...
		":nth-match": function(param, last) {
			...
			return nth(args.shift(), compileGroup(args.join(",")), last);
		},
		...
		":scope": function(el, con) {
			...
			if (context.nodeType === 9) return el === context.documentElement;
			return el === context;
		},
		...
		":contains": function(param) {
			return function(el) {
				return (el.innerText || el.textContent || el.value || "").indexOf(param) !== -1;
			};
		},
		":has": function(param) {
			return function(el) {
	...
	*/
	var combinators = {
		" ": function(test) {
			return function(el) {
				while (el = el.parentNode) if (test(el)) return el;
			};
		},
		">": function(test) {
			return function(el) {
				if (el = el.parentNode) return test(el) && el;
			};
		},
		"+": function(test) {
			return function(el) {
				if (el = prev(el)) return test(el) && el;
			};
		},
		"~": function(test) {
			return function(el) {
				while (el = prev(el)) if (test(el)) return el;
			};
		},
		"noop": function(test) {
			return function(el) {
		...
		"ref": function(test, name) {
			var node;
			function ref(el) {
				var nodes = el.ownerDocument.getElementsByTagName("*"), i = nodes.length;
				while (i--) {
					node = nodes[i];
					if (ref.test(el)) {
						node = null;
			...
			ref.combinator = function(el) {
				...
				if (attr === el.id && test(node)) return node;
			};
			return ref;
		}
	};
	...
	*/
	...
	var tok = function(cap, qname) {
		if (qname) return cap === "*" ? selectors["*"] : selectors.type(cap);
		if (cap[1]) return cap[1][0] === "." ? selectors.attr("class", "~=", decodeid(cap[1].substring(1)), false) : selectors.attr("id", "=", decodeid(cap[1].substring(1)), false);
		if (cap[2]) return cap[3] ? selectors[decodeid(cap[2])](unquote(cap[3])) : selectors[decodeid(cap[2])];
		if (cap[4]) {
			var value = cap[6];
			var i = /["'\s]\s*I$/i.test(value);
			if (i) value = value.replace(/\s*I$/i, "");
	...
	var makeSimple = function(func) {
		...
		return function(el) {
			if (!el) return;
			for (i = 0; i < l; i++) if (!func[i](el)) return;
			return true;
		};
	};
	var makeTest = function(func) {
		if (func.length < 2) return function(el) {
			return !!func[0](el);
		};
		return function(el) {
			var i = func.length;
			while (i--) if (!(el = func[i](el))) return;
			return true;
		};
	};
	var makeSubject = function() {
		var target;
		function subject(el) {
			var scope = el.ownerDocument.getElementsByTagName(subject.lname), i = scope.length;
			while (i--) if (subject.test(scope[i]) && target === el) {
				target = null;
				return true;
			}
			target = null;
	...
	var compileGroup = function(sel) {
		...
		return function(el) {
			...
			for (; i < l; i++) if (tests[i](el)) return true;
		};
	};
	/**
	* Selection
	*/
	var find = function(sel, node) {
		...
		while (el = scope[i++]) if (test(el)) results.push(el);
		if (test.sel) {
			while (test.sel) {
				test = compile(test.sel);
				scope = node.getElementsByTagName(test.qname);
				i = 0;
				while (el = scope[i++]) if (test(el) && indexOf.call(results, el) === -1) results.push(el);
			}
			results.sort(order);
		}
		return results;
	...
	*/
	module.exports = exports = function(sel, context) {
		...
		if (context.nodeType !== 11 && sel.indexOf(" ") === -1) {
			...
			if (sel[0] === "." && /^\.\w+$/.test(sel)) return context.getElementsByClassName(sel.substring(1));
			if (/^\w+$/.test(sel)) return context.getElementsByTagName(sel);
		}
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/ChildNode.js
var require_ChildNode = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Node = require_Node();
	var LinkedList = require_LinkedList();
	...
	module.exports = {
		...
		_remove: { value: function _remove() {
			...
			if (parent._childNodes) parent._childNodes.splice(this.index, 1);
			else if (parent._firstChild === this) if (this._nextSibling === this) parent._firstChild = null;
			else parent._firstChild = this._nextSibling;
		...
		replaceWith: { value: function replaceWith() {
			...
			var docFrag = createDocumentFragmentFromArguments(this.doc, argArr);
			if (this.parentNode === parentNode) parentNode.replaceChild(docFrag, this);
			else parentNode.insertBefore(docFrag, nextSibling);
		} }
	};
}));
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NonDocumentTypeChildNode.js
var require_NonDocumentTypeChildNode = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Node = require_Node();
	module.exports = {
		nextElementSibling: { get: function() {
			if (this.parentNode) {
				for (var kid = this.nextSibling; kid !== null; kid = kid.nextSibling) if (kid.nodeType === Node.ELEMENT_NODE) return kid;
			}
			return null;
		} },
		previousElementSibling: { get: function() {
			if (this.parentNode) {
				for (var kid = this.previousSibling; kid !== null; kid = kid.previousSibling) if (kid.nodeType === Node.ELEMENT_NODE) return kid;
			}
			return null;
		} }
	};
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NamedNodeMap.js
var require_NamedNodeMap = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/Element.js
var require_Element = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function recursiveGetText(node, a) {
		if (node.nodeType === Node.TEXT_NODE) a.push(node._data);
		else for (var i = 0, n = node.childNodes.length; i < n; i++) recursiveGetText(node.childNodes[i], a);
	}
	Element.prototype = Object.create(ContainerNode.prototype, {
		...
		tagName: { get: function tagName() {
			if (this._tagName === void 0) {
				var tn;
				if (this.prefix === null) tn = this.localName;
				else tn = this.prefix + ":" + this.localName;
				if (this.isHTML) {
					var up = uppercaseCache[tn];
					if (!up) uppercaseCache[tn] = up = utils.toASCIIUpperCase(tn);
					tn = up;
				}
				this._tagName = tn;
			}
		...
		textContent: {
			...
			set: function(newtext) {
				this.removeChildren();
				if (newtext !== null && newtext !== void 0 && newtext !== "") this._appendChild(this.ownerDocument.createTextNode(newtext));
			}
		},
		innerText: {
			get: function() {
		...
		outerHTML: {
			...
			set: function(v) {
				...
				var parent = this.parentNode;
				if (parent === null) return;
				if (parent.nodeType === Node.DOCUMENT_NODE) utils.NoModificationAllowedError();
				if (parent.nodeType === Node.DOCUMENT_FRAGMENT_NODE) parent = parent.ownerDocument.createElement("body");
		...
		_insertAdjacent: { value: function _insertAdjacent(position, node) {
			var first = false;
			switch (position) {
				case "beforebegin": first = true;
				case "afterend":
					var parent = this.parentNode;
					if (parent === null) return null;
					return parent.insertBefore(node, first ? this : this.nextSibling);
				case "afterbegin": first = true;
				case "beforeend": return this.insertBefore(node, first ? this.firstChild : null);
				default: return utils.SyntaxError();
			}
		} },
		insertAdjacentElement: { value: function insertAdjacentElement(position, element) {
			if (element.nodeType !== Node.ELEMENT_NODE) throw new TypeError("not an element");
		...
		insertAdjacentHTML: { value: function insertAdjacentHTML(position, text) {
			...
			switch (position) {
				...
				case "afterend":
					...
					if (context === null || context.nodeType === Node.DOCUMENT_NODE) utils.NoModificationAllowedError();
					break;
				case "afterbegin":
				case "beforeend":
					context = this;
					break;
				default: utils.SyntaxError();
			}
			if (!(context instanceof Element) || context.ownerDocument.isHTML && context.localName === "html" && context.namespaceURI === NAMESPACE.HTML) context = context.ownerDocument.createElementNS(NAMESPACE.HTML, "body");
			var parser = this.ownerDocument.implementation.mozHTMLParser(this.ownerDocument._address, context);
			parser.parse(text, true);
			this._insertAdjacent(position, parser._asDocumentFragment());
		} },
		children: { get: function() {
			if (!this._children) this._children = new ChildrenCollection(this);
			return this._children;
		} },
		attributes: { get: function() {
			if (!this._attributes) this._attributes = new AttributesArray(this);
			return this._attributes;
		} },
		firstElementChild: { get: function() {
			for (var kid = this.firstChild; kid !== null; kid = kid.nextSibling) if (kid.nodeType === Node.ELEMENT_NODE) return kid;
			return null;
		} },
		lastElementChild: { get: function() {
			for (var kid = this.lastChild; kid !== null; kid = kid.previousSibling) if (kid.nodeType === Node.ELEMENT_NODE) return kid;
			return null;
		} },
		...
		clone: { value: function clone() {
			var e;
			if (this.namespaceURI !== NAMESPACE.HTML || this.prefix || !this.ownerDocument.isHTML) e = this.ownerDocument.createElementNS(this.namespaceURI, this.prefix !== null ? this.prefix + ":" + this.localName : this.localName);
			else e = this.ownerDocument.createElement(this.localName);
			for (var i = 0, n = this._attrKeys.length; i < n; i++) {
				var lname = this._attrKeys[i];
				var b = this._attrsByLName[lname].cloneNode();
		...
		_lookupNamespacePrefix: { value: function _lookupNamespacePrefix(ns, originalElement) {
			if (this.namespaceURI && this.namespaceURI === ns && this.prefix !== null && originalElement.lookupNamespaceURI(this.prefix) === ns) return this.prefix;
			for (var i = 0, n = this._numattrs; i < n; i++) {
				var a = this._attr(i);
				if (a.prefix === "xmlns" && a.value === ns && originalElement.lookupNamespaceURI(a.localName) === ns) return a.localName;
			}
		...
		lookupNamespaceURI: { value: function lookupNamespaceURI(prefix) {
			...
			for (var i = 0, n = this._numattrs; i < n; i++) {
				...
				if (a.namespaceURI === NAMESPACE.XMLNS) {
					if (a.prefix === "xmlns" && a.localName === prefix || prefix === null && a.prefix === null && a.localName === "xmlns") return a.value || null;
				}
			}
			var parent = this.parentElement;
		...
		toggleAttribute: { value: function toggleAttribute(qname, force) {
			...
			if (/[A-Z]/.test(qname) && this.isHTML) qname = utils.toASCIILowerCase(qname);
			if (this._attrsByQName[qname] === void 0) {
				if (force === void 0 || force === true) {
		...
		_setAttribute: { value: function _setAttribute(qname, value) {
			...
			if (!attr) {
				...
				isnew = true;
			} else if (Array.isArray(attr)) attr = attr[0];
			attr.value = value;
		...
		_setAttributeNS: { value: function _setAttributeNS(ns, qname, value) {
			...
			if (!attr) {
				...
				if (this._attributes) this._attributes[this._attrKeys.length] = attr;
		...
		setAttributeNode: { value: function setAttributeNode(attr) {
			if (attr.ownerElement !== null && attr.ownerElement !== this) throw new DOMException(DOMException.INUSE_ATTRIBUTE_ERR);
			var result = null;
			...
			if (oldAttrs) {
				...
				else if (attr.ownerElement !== null) throw new DOMException(DOMException.INUSE_ATTRIBUTE_ERR);
		...
		removeAttribute: { value: function removeAttribute(qname) {
			...
			var attr = this._attrsByQName[qname];
			if (!attr) return;
			if (Array.isArray(attr)) if (attr.length > 2) attr = attr.shift();
			else {
				this._attrsByQName[qname] = attr[1];
				attr = attr[0];
			}
			else this._attrsByQName[qname] = void 0;
			var ns = attr.namespaceURI;
			var key = (ns === null ? "" : ns) + "|" + attr.localName;
			...
			if (onchange) onchange.call(attr, this, attr.localName, attr.value, null);
		...
		removeAttributeNode: { value: function removeAttributeNode(attr) {
			var ns = attr.namespaceURI;
			var key = (ns === null ? "" : ns) + "|" + attr.localName;
			if (this._attrsByLName[key] !== attr) utils.NotFoundError();
		...
		_addQName: { value: function(attr) {
			...
			if (!existing) this._attrsByQName[qname] = attr;
			else if (Array.isArray(existing)) existing.push(attr);
			else this._attrsByQName[qname] = [existing, attr];
			if (this._attributes) this._attributes[qname] = attr;
		} },
		_removeQName: { value: function(attr) {
			...
			if (Array.isArray(target)) {
				...
				if (target.length === 2) {
					...
					if (this._attributes) this._attributes[qname] = this._attrsByQName[qname];
				} else {
					target.splice(idx, 1);
					if (this._attributes && this._attributes[qname] === attr) this._attributes[qname] = target[0];
				}
			} else {
				utils.assert(target === attr);
				this._attrsByQName[qname] = void 0;
				if (this._attributes) this._attributes[qname] = void 0;
			}
		} },
	...
	attributes.registerChangeHandler(Element, "id", function(element, lname, oldval, newval) {
		if (element.rooted) {
			if (oldval) element.ownerDocument.delId(oldval, element);
			if (newval) element.ownerDocument.addId(newval, element);
		}
	});
	...
	Attr.prototype = Object.create(Object.prototype, {
		ownerElement: { get: function() {
			return this._ownerElement;
		} },
		_setOwnerElement: { value: function _setOwnerElement(elt) {
			this._ownerElement = elt;
			if (this.prefix === null && this.namespaceURI === null && elt) this.onchange = elt._attributeChangeHandlers[this.localName];
	...
	function AttributesArray(elt) {
		...
		for (var name in elt._attrsByQName) this[name] = elt._attrsByQName[name];
		for (var i = 0; i < elt._attrKeys.length; i++) this[i] = elt._attrsByLName[elt._attrKeys[i]];
	}
	...
	if (globalThis.Symbol?.iterator) AttributesArray.prototype[globalThis.Symbol.iterator] = function() {
	...
	ChildrenCollection.prototype = Object.create(Object.prototype, {
		...
		updateCache: { value: function updateCache() {
			...
			if (this.lastModTime !== this.element.lastModTime) {
				...
				for (var i = 0; i < n; i++) this[i] = void 0;
				this.childrenByNumber = [];
				this.childrenByName = Object.create(null);
				for (var c = this.element.firstChild; c !== null; c = c.nextSibling) if (c.nodeType === Node.ELEMENT_NODE) {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/Leaf.js
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/CharacterData.js
var require_CharacterData = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	CharacterData.prototype = Object.create(Leaf.prototype, {
		substringData: { value: function substringData(offset, count) {
			...
			offset = offset >>> 0;
			count = count >>> 0;
			if (offset > this.data.length || offset < 0 || count < 0) utils.IndexSizeError();
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/Text.js
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/Comment.js
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/DocumentFragment.js
var require_DocumentFragment = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/ProcessingInstruction.js
var require_ProcessingInstruction = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NodeFilter.js
var require_NodeFilter = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var NodeFilter = {
		FILTER_ACCEPT: 1,
		FILTER_REJECT: 2,
		FILTER_SKIP: 3,
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NodeTraversal.js
var require_NodeTraversal = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
	...
	*/
	function nextSkippingChildren(node, stayWithin) {
		if (node === stayWithin) return null;
	...
	*/
	function previous(node, stayWithin) {
		...
		if (p !== null) return deepLastChild(p);
		p = node.parentNode;
		if (p === stayWithin) return null;
		return p;
	}
}));
//#endregion
//#region node_modules/@mixmark-io/domino/lib/TreeWalker.js
var require_TreeWalker = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function traverseChildren(tw, type) {
		var child, node = tw._currentNode[mapChild[type]], parent, result, sibling;
		while (node !== null) {
			...
			while (node !== null) {
				...
				if (parent === null || parent === tw.root || parent === tw._currentNode) return null;
				else node = parent;
			}
		}
		return null;
	...
	*/
	function traverseSiblings(tw, type) {
		var node = tw._currentNode, result, sibling;
		...
		while (true) {
			...
			while (sibling !== null) {
				...
				if (result === NodeFilter.FILTER_REJECT || sibling === null) sibling = node[mapSibling[type]];
			}
			node = node.parentNode;
			if (node === null || node === tw.root) return null;
			if (tw._internalFilter(node) === NodeFilter.FILTER_ACCEPT) return null;
		}
	}
	/**
	...
	*/
	function TreeWalker(root, whatToShow, filter) {
		if (!root || !root.nodeType) utils.NotSupportedError();
		this._root = root;
	...
	Object.defineProperties(TreeWalker.prototype, {
		...
		currentNode: {
			...
			set: function setCurrentNode(v) {
				if (!(v instanceof Node)) throw new TypeError("Not a Node");
				this._currentNode = v;
			}
		},
		/**
		...
		*/
		_internalFilter: { value: function _internalFilter(node) {
			var result, filter;
			if (this._active) utils.InvalidStateError();
			if (!(1 << node.nodeType - 1 & this._whatToShow)) return NodeFilter.FILTER_SKIP;
			filter = this._filter;
			if (filter === null) result = NodeFilter.FILTER_ACCEPT;
			else {
				this._active = true;
				try {
					if (typeof filter === "function") result = filter(node);
					else result = filter.acceptNode(node);
				} finally {
					this._active = false;
				}
			}
		...
		*/
		previousNode: { value: function previousNode() {
			var node = this._currentNode, result, previousSibling, lastChild;
		...
		*/
		nextNode: { value: function nextNode() {
			var node = this._currentNode, result = NodeFilter.FILTER_ACCEPT, firstChild, nextSibling;
			CHILDREN: while (true) {
				for (firstChild = node.firstChild; firstChild; firstChild = node.firstChild) {
					...
					if (result === NodeFilter.FILTER_ACCEPT) {
						this._currentNode = node;
						return node;
					} else if (result === NodeFilter.FILTER_REJECT) break;
				}
				for (nextSibling = NodeTraversal.nextSkippingChildren(node, this.root); nextSibling; nextSibling = NodeTraversal.nextSkippingChildren(node, this.root)) {
					...
					if (result === NodeFilter.FILTER_ACCEPT) {
						this._currentNode = node;
						return node;
					} else if (result === NodeFilter.FILTER_SKIP) continue CHILDREN;
				}
				return null;
			}
		} },
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NodeIterator.js
var require_NodeIterator = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function move(node, stayWithin, directionIsNext) {
		if (directionIsNext) return NodeTraversal.next(node, stayWithin);
		else {
			if (node === stayWithin) return null;
	...
	function isInclusiveAncestor(node, possibleChild) {
		for (; possibleChild; possibleChild = possibleChild.parentNode) if (node === possibleChild) return true;
		return false;
	}
	/**
	...
	*/
	function traverse(ni, directionIsNext) {
		var node = ni._referenceNode, beforeNode = ni._pointerBeforeReferenceNode;
		while (true) {
			if (beforeNode === directionIsNext) beforeNode = !beforeNode;
			else {
				node = move(node, ni._root, directionIsNext);
				if (node === null) return null;
			}
			if (ni._internalFilter(node) === NodeFilter.FILTER_ACCEPT) break;
		}
	...
	Object.defineProperties(NodeIterator.prototype, {
		...
		*/
		_preremove: { value: function _preremove(toBeRemovedNode) {
			...
			if (toBeRemovedNode.previousSibling === null) this._referenceNode = toBeRemovedNode.parentNode;
			else {
				this._referenceNode = toBeRemovedNode.previousSibling;
				var lastChild;
				for (lastChild = this._referenceNode.lastChild; lastChild; lastChild = this._referenceNode.lastChild) this._referenceNode = lastChild;
			}
		} },
		/**
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/URL.js
		...
		resolve: function(relative) {
			...
			if (r.scheme !== void 0) {
				...
				if (r.host !== void 0) {
					...
					if (!r.path) {
						...
						if (r.path.charAt(0) === "/") t.path = remove_dot_segments(r.path);
						else {
			...
			function remove_dot_segments(path) {
				...
				while (path.length > 0) {
					...
					if (threechars === "../") path = path.substring(3);
					else if (twochars === "./") path = path.substring(2);
					else if (threechars === "/./") path = "/" + path.substring(3);
					else if (twochars === "/." && path.length === 2) path = "/";
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/CustomEvent.js
var require_CustomEvent = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/events.js
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/style_parser.js
var require_style_parser = /* @__PURE__ */ __commonJSMin(((exports) => {
	/**
	* @license
	...
	*/
	function parse(value) {
		...
		while (i < value.length) switch (value.charCodeAt(i++)) {
			case 40:
				parenDepth++;
				break;
			case 41:
			...
			case 39:
				if (quote === 0) quote = 39;
				else if (quote === 39 && value.charCodeAt(i - 1) !== 92) quote = 0;
				break;
			case 34:
				if (quote === 0) quote = 34;
				else if (quote === 34 && value.charCodeAt(i - 1) !== 92) quote = 0;
				break;
			case 58:
				...
				break;
			case 59: if (currentProp && valueStart > 0 && parenDepth === 0 && quote === 0) {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/CSSStyleDeclaration.js
var require_CSSStyleDeclaration = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = function(elt) {
		...
		return new Proxy(style, {
			...
			set: function(target, property, value) {
				...
				else target.setProperty(dasherizeProperty(property), value ?? void 0);
				return true;
			}
		});
	};
	...
	function parseStyles(value) {
		...
		if (styleValues.length < 2) return result;
	...
	CSSStyleDeclaration.prototype = Object.create(Object.prototype, {
		...
		_serialize: { value: function() {
			...
			for (var name in styles.property) {
				...
				if (styles.priority[name]) s += " !" + styles.priority[name];
				s += ";";
			}
			this.cssText = s;
		...
		setProperty: { value: function(property, value, priority) {
			...
			if (priority === null || priority === void 0) priority = "";
			if (value !== NO_CHANGE) value = "" + value;
			value = value.trim();
			if (value === "") {
				this.removeProperty(property);
				return;
			}
			if (priority !== "" && priority !== NO_CHANGE && !/^important$/i.test(priority)) return;
			var styles = this._parsed;
			if (value === NO_CHANGE) {
				if (!styles.property[property]) return;
				if (priority !== "") styles.priority[property] = "important";
				else delete styles.priority[property];
			} else {
				if (value.indexOf(";") !== -1) return;
				var newprops = parseStyles(property + ":" + value);
				if (Object.getOwnPropertyNames(newprops.property).length === 0) return;
				if (Object.getOwnPropertyNames(newprops.priority).length !== 0) return;
				for (var p in newprops.property) {
					styles.property[p] = newprops.property[p];
					if (priority === NO_CHANGE) continue;
					else if (priority !== "") styles.priority[p] = "important";
					else if (styles.priority[p]) delete styles.priority[p];
				}
			}
			this._serialize();
		} },
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/URLUtils.js
var require_URLUtils = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var URL = require_URL();
	...
	URLUtils.prototype = Object.create(Object.prototype, {
		...
		hash: {
			get: function() {
				var url = this._url;
				if (url == null || url.fragment == null || url.fragment === "") return "";
				else return "#" + url.fragment;
			},
			set: function(v) {
				var output = this.href;
				var url = new URL(output);
		...
		origin: { get: function() {
			...
			switch (url.scheme) {
				case "ftp": return originForPort(21);
				case "gopher": return originForPort(70);
				case "http":
				case "ws": return originForPort(80);
				case "https":
				case "wss": return originForPort(443);
				default: return url.scheme + "://";
			}
		} }
	});
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/defineElement.js
var require_defineElement = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var attributes = require_attributes();
	var isApiWritable = require_config().isApiWritable;
	module.exports = function(spec, defaultConstructor, tagList, tagNameToImpl) {
		...
		if (c) {
			...
			if (spec.attributes) for (var n in spec.attributes) {
			...
			if (spec.events) addEventHandlers(c, spec.events);
			tagList[spec.name] = c;
		} else c = defaultConstructor;
	...
	function EventHandlerChangeHandler(elt, name, oldval, newval) {
		elt[name] = new EventHandlerBuilder(newval, elt.ownerDocument || Object.create(null), elt.form || Object.create(null), elt).build();
	}
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/htmlelts.js
var require_htmlelts = /* @__PURE__ */ __commonJSMin(((exports) => {
	var Node = require_Node();
	var Element = require_Element();
	...
	exports.createElement = function(doc, localName, prefix) {
		return new (htmlNameToImpl[localName] || HTMLUnknownElement)(doc, localName, prefix);
	};
	...
	function CORS(attr) {
		return {
			...
			set: function(value) {
				if (value === null || value === void 0) this.removeAttribute(attr);
				else this._setattr(attr, value);
			}
		};
	}
	var REFERRER = {
	...
	var HTMLElement = exports.HTMLElement = define({
		...
		props: {
			dangerouslySetInnerHTML: { set: function(v) {
				this._innerHTML = v;
			} },
			innerHTML: {
				get: function() {
	...
	define({
		...
		props: { text: {
			...
			set: function(value) {
				this.removeChildren();
				if (value !== null && value !== "") this.appendChild(this.ownerDocument.createTextNode(value));
			}
		} },
		attributes: {
			src: URL,
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/svg.js
var require_svg = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.createElement = function(doc, localName, prefix) {
		return new (svgNameToImpl[localName] || SVGElement)(doc, localName, prefix);
	};
	function define(spec) {
	...
	define({
		...
		tag: "svg",
		props: { createSVGRect: { value: function() {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/MutationConstants.js
var require_MutationConstants = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		VALUE: 1,
		ATTR: 2,
		REMOVE_ATTR: 3,
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/Document.js
var require_Document = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function validateAndExtract(namespace, qualifiedName) {
		...
		if (prefix !== null && namespace === null) utils.NamespaceError();
		if (prefix === "xml" && namespace !== NAMESPACE.XML) utils.NamespaceError();
		if ((prefix === "xmlns" || qualifiedName === "xmlns") && namespace !== NAMESPACE.XMLNS) utils.NamespaceError();
		if (namespace === NAMESPACE.XMLNS && !(prefix === "xmlns" || qualifiedName === "xmlns")) utils.NamespaceError();
		return {
			namespace,
			prefix,
			localName
	...
	Document.prototype = Object.create(ContainerNode.prototype, {
		...
		createElement: {
			value: function(localName) {
				...
				} else if (this.contentType === "application/xhtml+xml") return html.createElement(this, localName, null);
				else return new Element(this, localName, null, null);
			},
			writable: isApiWritable
		},
		createElementNS: {
		...
		_createElementNS: { value: function(localName, namespace, prefix) {
			if (namespace === NAMESPACE.HTML) return html.createElement(this, localName, prefix);
			else if (namespace === NAMESPACE.SVG) return svg.createElement(this, localName, prefix);
			return new Element(this, localName, namespace, prefix);
		} },
		createEvent: { value: function createEvent(interfaceName) {
			interfaceName = interfaceName.toLowerCase();
			var constructor = events[supportedEvents[replacementEvent[interfaceName] || interfaceName]];
			if (constructor) {
				var e = new constructor();
				e._initialized = false;
				return e;
			} else utils.NotSupportedError();
		} },
		...
		_preremoveNodeIterators: { value: function(toBeRemoved) {
			if (this._nodeIterators) this._nodeIterators.forEach(function(ni) {
				ni._preremove(toBeRemoved);
			});
		} },
		_updateDocTypeElement: { value: function _updateDocTypeElement() {
			this.doctype = this.documentElement = null;
			for (var kid = this.firstChild; kid !== null; kid = kid.nextSibling) if (kid.nodeType === Node.DOCUMENT_TYPE_NODE) this.doctype = kid;
		...
		getElementById: { value: function(id) {
			var n = this.byId[id];
			if (!n) return null;
			if (n instanceof MultiId) return n.getFirst();
			return n;
		} },
		...
		_titleElement: { get: function() {
			return this.getElementsByTagName("title").item(0) || null;
		} },
		title: {
			get: function() {
				var elt = this._titleElement;
				return (elt ? elt.textContent : "").replace(/[ \t\n\r\f]+/g, " ").replace(/(^ )|( $)/g, "");
			},
			set: function(value) {
				var elt = this._titleElement;
				var head = this.head;
		...
		close: { value: function() {
			...
			this._dispatchEvent(new Event("readystatechange"), true);
			if (this.defaultView) this.defaultView._dispatchEvent(new Event("load"), true);
		} },
		clone: { value: function clone() {
		...
		cloneNode: { value: function cloneNode(deep) {
			...
			if (deep) for (var kid = this.firstChild; kid !== null; kid = kid.nextSibling) clone._appendChild(clone.importNode(kid, true));
		...
		delId: { value: function delId(id, n) {
			...
			if (val instanceof MultiId) {
				val.del(n);
				if (val.length === 1) this.byId[id] = val.downgrade();
			} else this.byId[id] = void 0;
		} },
		...
		_documentBaseURL: { get: function() {
			...
			if (base) return new URL(url).resolve(base.getAttribute("href"));
			return url;
		} },
	...
	function namedHTMLChild(parent, name) {
		if (parent && parent.isHTML) {
			for (var kid = parent.firstChild; kid !== null; kid = kid.nextSibling) if (kid.nodeType === Node.ELEMENT_NODE && kid.localName === name && kid.namespaceURI === NAMESPACE.HTML) return kid;
		}
		return null;
	}
	function root(n) {
	...
	function recursivelyRoot(node) {
		root(node);
		if (node.nodeType === Node.ELEMENT_NODE) for (var kid = node.firstChild; kid !== null; kid = kid.nextSibling) recursivelyRoot(kid);
	}
	...
	function recursivelySetOwner(node, owner) {
		...
		if (Object.prototype.hasOwnProperty.call(node, "_tagName")) node._tagName = void 0;
	...
	MultiId.prototype.getFirst = function() {
		if (!this.firstNode) {
			var nid;
			for (nid in this.nodes) if (this.firstNode === void 0 || this.firstNode.compareDocumentPosition(this.nodes[nid]) & Node.DOCUMENT_POSITION_PRECEDING) this.firstNode = this.nodes[nid];
		}
	...
	MultiId.prototype.downgrade = function() {
		if (this.length === 1) {
			var nid;
			for (nid in this.nodes) return this.nodes[nid];
		}
		return this;
	};
}));
//#endregion
//#region node_modules/@mixmark-io/domino/lib/DocumentType.js
var require_DocumentType = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/HTMLParser.js
var require_HTMLParser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function buf2str(buf) {
		var CHUNKSIZE = 16384;
		if (buf.length < CHUNKSIZE) return String.fromCharCode.apply(String, buf);
		var result = "";
		for (var i = 0; i < buf.length; i += CHUNKSIZE) result += String.fromCharCode.apply(String, buf.slice(i, i + CHUNKSIZE));
		return result;
	}
	function str2buf(s) {
		var result = [];
	...
	function isA(elt, set) {
		if (typeof set === "string") return elt.namespaceURI === NAMESPACE.HTML && elt.localName === set;
	...
	function adjustSVGAttributes(attrs) {
		for (var i = 0, n = attrs.length; i < n; i++) if (attrs[i][0] in svgAttrAdjustments) attrs[i][0] = svgAttrAdjustments[attrs[i][0]];
	}
	function adjustMathMLAttributes(attrs) {
		for (var i = 0, n = attrs.length; i < n; i++) if (attrs[i][0] === "definitionurl") {
			attrs[i][0] = "definitionURL";
			break;
		}
	}
	function adjustForeignAttributes(attrs) {
		for (var i = 0, n = attrs.length; i < n; i++) if (attrs[i][0] in foreignAttributes) attrs[i].push(foreignAttributes[attrs[i][0]]);
	}
	...
	*/
	...
	HTMLParser.ElementStack.prototype.popElementType = function(type) {
		for (var i = this.elements.length - 1; i > 0; i--) if (this.elements[i] instanceof type) break;
		this.elements.length = i;
		this.top = this.elements[i - 1];
	};
	HTMLParser.ElementStack.prototype.popElement = function(e) {
		for (var i = this.elements.length - 1; i > 0; i--) if (this.elements[i] === e) break;
		this.elements.length = i;
		this.top = this.elements[i - 1];
	};
	...
	HTMLParser.ElementStack.prototype.clearToContext = function(set) {
		for (var i = this.elements.length - 1; i > 0; i--) if (isA(this.elements[i], set)) break;
	...
	*/
	...
	HTMLParser.ActiveFormattingElements.prototype.push = function(elt, attrs) {
		...
		this.list.push(elt);
		var attrcopy = [];
		for (var ii = 0; ii < attrs.length; ii++) attrcopy[ii] = attrs[ii];
	...
	HTMLParser.ActiveFormattingElements.prototype.clearToMarker = function() {
		for (var i = this.list.length - 1; i >= 0; i--) if (this.list[i] === this.MARKER) break;
		if (i < 0) i = 0;
		this.list.length = i;
		this.attrs.length = i;
	};
	...
	*/
	function HTMLParser(address, fragmentContext, options) {
		...
		*/
		...
		if (fragmentContext) scripting_enabled = fragmentContext.ownerDocument._scripting_enabled;
		...
		*/
		if (fragmentContext) {
			...
			if (fragmentContext.namespaceURI === NAMESPACE.HTML) switch (fragmentContext.localName) {
				case "title":
				case "textarea":
				...
				case "noframes":
				case "script":
				case "plaintext": tokenizer = plaintext_state;
			}
			var root = doc.createElement("html");
			doc._appendChild(root);
			stack.push(root);
			if (fragmentContext instanceof impl.HTMLTemplateElement) templateInsertionModes.push(in_template_mode);
			resetInsertionMode();
			for (var e = fragmentContext; e !== null; e = e.parentElement) if (e instanceof impl.HTMLFormElement) {
		...
		*/
		function scanChars(shouldPauseFunc) {
			...
			while (nextchar < numchars) {
				if (paused > 0 || shouldPauseFunc && shouldPauseFunc()) return true;
					...
					case "undefined":
						...
						switch (codepoint) {
							case 13:
								...
								} else scanner_skip_newline = true;
								tokenizer(10);
								break;
							case 65535: if (input_complete && nextchar === numchars) {
								tokenizer(EOF);
								break;
							}
							default: tokenizer(codepoint);
						}
						break;
					case "number":
						codepoint = chars.charCodeAt(nextchar);
		...
		*/
		function addAttribute(name, value) {
			for (var i = 0; i < attributes.length; i++) if (attributes[i][0] === name) return;
			if (value !== void 0) attributes.push([name, value]);
		...
		function handleSimpleAttribute() {
			...
			for (var i = 0; i < attributes.length; i++) if (attributes[i][0] === name) return true;
		...
		function emitSimpleTag() {
			if (nextchar === numchars) return false;
		...
		function emitSelfClosingTag() {
			...
			else insertToken(TAG, tagnamebuf, attributes, true);
		}
		...
		var insertToken = htmlparser.insertToken = function insertToken(t, value, arg3, arg4) {
			...
			if (!current || current.namespaceURI === NAMESPACE.HTML) parser(t, value, arg3, arg4);
			else if (t !== TAG && t !== TEXT) insertForeignToken(t, value, arg3, arg4);
			else if (isMathmlTextIntegrationPoint(current) && (t === TEXT || t === TAG && value !== "mglyph" && value !== "malignmark") || t === TAG && value === "svg" && current.namespaceURI === NAMESPACE.MATHML && current.localName === "annotation-xml" || isHTMLIntegrationPoint(current)) {
				text_integration_mode = true;
				parser(t, value, arg3, arg4);
				text_integration_mode = false;
			} else insertForeignToken(t, value, arg3, arg4);
		};
		/***
		...
		*/
		function insertComment(data) {
			...
			if (foster_parent_mode && isA(parent, tablesectionrowSet)) fosterParent(function(doc) {
				return doc.createComment(data);
			});
			else {
				if (parent instanceof impl.HTMLTemplateElement) parent = parent.content;
		...
		function insertText(s) {
			...
			if (foster_parent_mode && isA(parent, tablesectionrowSet)) fosterParent(function(doc) {
				...
				if (lastChild && lastChild.nodeType === Node.TEXT_NODE) lastChild.appendData(s);
				else parent._appendChild(parent.ownerDocument.createTextNode(s));
			}
		}
		function createHTMLElt(doc, name, attrs) {
			var elt = html.createElement(doc, name, null);
			if (attrs) for (var i = 0, n = attrs.length; i < n; i++) elt._setAttribute(attrs[i][0], attrs[i][1]);
			return elt;
		}
		...
		function insertHTMLElement(name, attrs) {
			...
			if (isA(elt, formassociatedSet)) elt._form = form_element_pointer;
			return elt;
		}
		function insertElement(eltFunc) {
			var elt;
			if (foster_parent_mode && isA(stack.top, tablesectionrowSet)) elt = fosterParent(eltFunc);
		...
		function insertForeignElement(name, attrs, ns) {
			return insertElement(function(doc) {
				...
				if (attrs) for (var i = 0, n = attrs.length; i < n; i++) {
					var attr = attrs[i];
					if (attr.length === 2) elt._setAttribute(attr[0], attr[1]);
					else elt._setAttributeNS(attr[2], attr[0], attr[1]);
				}
				return elt;
			});
		}
		function lastElementOfType(type) {
			for (var i = stack.elements.length - 1; i >= 0; i--) if (stack.elements[i] instanceof type) return i;
			return -1;
		}
		function fosterParent(eltFunc) {
			...
			if (lastTemplate >= 0 && (lastTable < 0 || lastTemplate > lastTable)) parent = stack.elements[lastTemplate];
			else if (lastTable >= 0) {
				parent = stack.elements[lastTable].parentNode;
				if (parent) before = stack.elements[lastTable];
				else parent = stack.elements[lastTable - 1];
			}
		...
		function resetInsertionMode() {
			...
			for (var i = stack.elements.length - 1; i >= 0; i--) {
				...
				if (i === 0) {
					last = true;
					if (fragment) node = fragmentContext;
				}
					...
					switch (tag) {
						case "select":
							for (var j = i; j > 0;) {
								...
								if (ancestor instanceof impl.HTMLTemplateElement) break;
						...
						case "frameset":
							...
							return;
						case "html":
							if (head_element_pointer === null) parser = before_head_mode;
							else parser = after_head_mode;
							return;
						default: if (!last) {
							if (tag === "head") {
								parser = in_head_mode;
		...
		function adoptionAgency(tag) {
			...
			while (outer < 8) {
				...
				if (!fmtelt) return false;
				var index = stack.elements.lastIndexOf(fmtelt);
				if (index === -1) {
					afe.remove(fmtelt);
					return true;
				}
				if (!stack.elementInScope(fmtelt)) return true;
				var furthestblock = null, furthestblockindex;
				for (var i = index + 1; i < stack.elements.length; i++) if (isA(stack.elements[i], specialSet)) {
				...
				if (!furthestblock) {
					...
					if (foster_parent_mode && isA(ancestor, tablesectionrowSet)) fosterParent(function() {
						return lastnode;
					});
					else if (ancestor instanceof impl.HTMLTemplateElement) ancestor.content._appendChild(lastnode);
					else ancestor._appendChild(lastnode);
					var newelt2 = afeclone(furthestblock.ownerDocument, afe.indexOf(fmtelt));
					while (furthestblock.hasChildNodes()) newelt2.elt._appendChild(furthestblock.firstChild);
		...
		function stopParsing() {
			...
			if (doc.defaultView) doc.defaultView.dispatchEvent(new impl.Event("load", {}));
		}
		/****
		* Tokenizer states
		*/
		...
		*/
		...
		function data_state(c) {
			switch (c) {
				...
				case -1:
					emitEOF();
					break;
				default: emitCharsWhile(DATATEXT) || textrun.push(c);
			}
		}
		...
		function rawtext_state(c) {
			switch (c) {
				...
				case -1:
					emitEOF();
					break;
				default: emitCharsWhile(RAWTEXT) || textrun.push(c);
			}
		}
		...
		function plaintext_state(c) {
			switch (c) {
				...
				case -1:
					emitEOF();
					break;
				default: emitCharsWhile(PLAINTEXT) || textrun.push(c);
			}
		}
		...
		function end_tag_open_state(c) {
			switch (c) {
				...
				case -1:
					...
					emitEOF();
					break;
				default: reconsume(c, bogus_comment_state);
			}
		}
		function tag_name_state(c) {
			switch (c) {
				...
				case -1:
					emitEOF();
					break;
				default: tagnamebuf += getMatchingChars(TAGNAME);
			}
		}
		...
		function script_data_escape_start_state(c) {
			if (c === 45) {
				...
				textrun.push(45);
			} else reconsume(c, script_data_state);
		}
		...
		function script_data_double_escape_start_state(c) {
			switch (c) {
				...
				case 47:
				case 62:
					if (buf2str(tempbuf) === "script") tokenizer = script_data_double_escaped_state;
					else tokenizer = script_data_escaped_state;
					textrun.push(c);
					break;
				case 65:
				case 66:
				...
				case 122:
					...
					textrun.push(c);
					break;
				default: reconsume(c, script_data_escaped_state);
			}
		}
		...
		function script_data_double_escaped_less_than_sign_state(c) {
			if (c === 47) {
				...
				textrun.push(47);
			} else reconsume(c, script_data_double_escaped_state);
		}
		function script_data_double_escape_end_state(c) {
			switch (c) {
				...
				case 47:
				case 62:
					if (buf2str(tempbuf) === "script") tokenizer = script_data_escaped_state;
					else tokenizer = script_data_double_escaped_state;
					textrun.push(c);
					break;
				case 65:
				case 66:
				...
				case 122:
					...
					textrun.push(c);
					break;
				default: reconsume(c, script_data_double_escaped_state);
			}
		}
		...
		function attribute_name_state(c) {
			switch (c) {
				...
				case 0:
					...
					break;
				default: attrnamebuf += getMatchingChars(ATTRNAME);
			}
		}
		...
		function attribute_value_double_quoted_state(c) {
			switch (c) {
				...
				case 10:
					...
					break;
				default: attrvaluebuf += getMatchingChars(DBLQUOTEATTRVAL);
			}
		}
		function attribute_value_single_quoted_state(c) {
			switch (c) {
				...
				case 10:
					attrvaluebuf += String.fromCharCode(c);
					break;
				default: attrvaluebuf += getMatchingChars(SINGLEQUOTEATTRVAL);
			}
		}
		function attribute_value_unquoted_state(c) {
			switch (c) {
				...
				case -1:
					...
					tokenizer = data_state;
					break;
				default: attrvaluebuf += getMatchingChars(UNQUOTEDATTRVAL);
			}
		}
		function after_attribute_value_quoted_state(c) {
			switch (c) {
				...
				case -1:
					emitEOF();
					break;
				default: reconsume(c, before_attribute_name_state);
			}
		}
		...
		function markup_declaration_open_state(c, lookahead, eof) {
			...
			} else tokenizer = bogus_comment_state;
		}
		...
		function comment_start_state(c) {
			...
			switch (c) {
				...
				case 62:
					...
					break;
				default: reconsume(c, comment_state);
			}
		}
		...
		function comment_less_than_sign_bang_dash_state(c) {
			switch (c) {
				case 45:
					...
					break;
				default: reconsume(c, comment_end_dash_state);
			}
		}
		function comment_less_than_sign_bang_dash_dash_state(c) {
			switch (c) {
				...
				case -1:
					...
					break;
				default: reconsume(c, comment_end_state);
			}
		}
		...
		function doctype_state(c) {
			switch (c) {
				...
				case -1:
					...
					emitEOF();
					break;
				default: reconsume(c, before_doctype_name_state);
			}
		}
		...
		function doctype_public_identifier_double_quoted_state(c) {
			switch (c) {
				...
				case -1:
					...
					emitEOF();
					break;
				default: doctypepublicbuf.push(c);
			}
		}
		...
		function doctype_system_identifier_double_quoted_state(c) {
			switch (c) {
				...
				case -1:
					...
					emitEOF();
					break;
				default: doctypesystembuf.push(c);
			}
		}
		...
		function after_doctype_system_identifier_state(c) {
			switch (c) {
				...
				case -1:
					...
					emitEOF();
					break;
				default: tokenizer = bogus_doctype_state;
			}
		}
		...
		function cdata_section_state(c) {
			switch (c) {
				...
				case -1:
					emitEOF();
					break;
				case 0: textIncludesNUL = true;
				default: emitCharsWhile(CDATATEXT) || textrun.push(c);
			}
		}
		...
		function character_reference_state(c) {
			...
			switch (c) {
				...
				case 35:
					...
					break;
				default: reconsume(c, named_character_reference_state);
			}
		}
		function named_character_reference_state(c) {
			...
			switch (return_state) {
				...
				case attribute_value_unquoted_state: if (name[name.length - 1] !== ";") {
			...
			if (typeof rv === "number") tempbuf.push(rv);
			else pushAll(tempbuf, rv);
			tokenizer = character_reference_end_state;
		}
		...
		function numeric_character_reference_state(c) {
			...
			switch (c) {
				...
				case 88:
					...
					break;
				default: reconsume(c, decimal_character_reference_start_state);
			}
		}
		function hexadecimal_character_reference_start_state(c) {
			switch (c) {
				...
				case 102:
					...
					break;
				default: reconsume(c, character_reference_end_state);
			}
		}
		...
		function hexadecimal_character_reference_state(c) {
			switch (c) {
				...
				case 59:
					...
					break;
				default: reconsume(c, numeric_character_reference_end_state);
			}
		}
		...
		function numeric_character_reference_end_state(c) {
			if (character_reference_code in numericCharRefReplacements) character_reference_code = numericCharRefReplacements[character_reference_code];
			else if (character_reference_code > 1114111 || character_reference_code >= 55296 && character_reference_code < 57344) character_reference_code = 65533;
			beginTempBuf();
			if (character_reference_code <= 65535) tempbuf.push(character_reference_code);
			else {
		...
		function character_reference_end_state(c) {
			switch (return_state) {
				...
				case attribute_value_unquoted_state:
					...
					break;
				default: pushAll(textrun, tempbuf);
			}
		...
		*/
				...
				case 2:
					switch (value) {
						case "html":
							...
							return;
						case "head":
							head_element_pointer = insertHTMLElement(value, arg3);
							parser = in_head_mode;
							return;
					}
					break;
		...
		function in_head_mode(t, value, arg3, arg4) {
			switch (t) {
				...
				case 2:
					switch (value) {
						...
						case "title":
							...
							return;
						case "noscript": if (!scripting_enabled) {
							insertHTMLElement(value, arg3);
				...
				case 3: switch (value) {
					...
					case "br": break;
					case "template":
						if (!stack.contains("template")) return;
		...
		function after_head_mode(t, value, arg3, arg4) {
			switch (t) {
				...
				case 2:
					...
					break;
				case 3: switch (value) {
					case "template": return in_head_mode(t, value, arg3, arg4);
					case "body":
					case "html":
					case "br": break;
					default: return;
		...
		function in_body_mode(t, value, arg3, arg4) {
			...
			switch (t) {
				...
				case 4:
					...
					return;
				case -1:
					if (templateInsertionModes.length) return in_template_mode(t);
					stopParsing();
					return;
				case 2:
					switch (value) {
						...
						case "menu":
							if (stack.inButtonScope("p")) in_body_mode(ENDTAG, "p");
							if (isA(stack.top, "menuitem")) stack.pop();
							insertHTMLElement(value, arg3);
							return;
						case "h1":
						case "h2":
						...
						case "object":
							...
							return;
						case "table":
							if (!doc._quirks && stack.inButtonScope("p")) in_body_mode(ENDTAG, "p");
							insertHTMLElement(value, arg3);
							frameset_ok = false;
							parser = in_table_mode;
							return;
						...
						case "optgroup":
						case "option":
							if (stack.top instanceof impl.HTMLOptionElement) in_body_mode(ENDTAG, "option");
							afereconstruct();
							insertHTMLElement(value, arg3);
							return;
						case "menuitem":
						...
						case "rb":
						case "rtc":
							if (stack.inScope("ruby")) stack.generateImpliedEndTags();
							insertHTMLElement(value, arg3);
							return;
						case "rp":
						case "rt":
							if (stack.inScope("ruby")) stack.generateImpliedEndTags("rtc");
							insertHTMLElement(value, arg3);
							return;
						case "math":
							afereconstruct();
				...
				case 3:
					switch (value) {
						...
						case "tt":
						case "u":
							if (adoptionAgency(value)) return;
							break;
						case "applet":
						case "marquee":
						case "object":
					...
					for (i = stack.elements.length - 1; i >= 0; i--) {
						...
						if (isA(node, value)) {
							...
							break;
						} else if (isA(node, specialSet)) return;
					}
					return;
			}
		}
		function text_mode(t, value, arg3, arg4) {
			switch (t) {
				...
				case -1:
					...
					return;
				case 3:
					if (value === "script") handleScriptEnd();
					else {
						stack.pop();
						parser = originalInsertionMode;
					}
		...
		function in_table_mode(t, value, arg3, arg4) {
			function getTypeAttr(attrs) {
				for (var i = 0, n = attrs.length; i < n; i++) if (attrs[i][0] === "type") return attrs[i][1].toLowerCase();
				return null;
			}
			switch (t) {
				case 1:
				...
				case 2:
					switch (value) {
						...
						case "template":
							...
							return;
						case "input":
							if (getTypeAttr(arg3) !== "hidden") break;
							insertHTMLElement(value, arg3);
							stack.pop();
							return;
						case "form":
		...
		function in_column_group_mode(t, value, arg3, arg4) {
			switch (t) {
				...
				case 3:
					switch (value) {
						case "colgroup":
							if (!isA(stack.top, "colgroup")) return;
							stack.pop();
							parser = in_table_mode;
							return;
						case "col": return;
		...
		function in_select_mode(t, value, arg3, arg4) {
			switch (t) {
				...
				case 3: switch (value) {
					case "optgroup":
						if (stack.top instanceof impl.HTMLOptionElement && stack.elements[stack.elements.length - 2] instanceof impl.HTMLOptGroupElement) in_select_mode(ENDTAG, "option");
		...
		function in_template_mode(t, value, arg3, arg4) {
			...
			switch (t) {
				...
				case 5:
					...
					return;
				case -1:
					if (!stack.contains("template")) stopParsing();
					else {
						stack.popTag("template");
						afe.clearToMarker();
						templateInsertionModes.pop();
		...
		function insertForeignToken(t, value, arg3, arg4) {
			function isHTMLFont(attrs) {
				for (var i = 0, n = attrs.length; i < n; i++) switch (attrs[i][0]) {
					case "color":
					case "face":
			...
			switch (t) {
				case 1:
					...
					if (textIncludesNUL) value = value.replace(NULCHARS, "�");
					insertText(value);
					return;
				case 4:
					insertComment(value);
				...
				case 2:
					switch (value) {
						case "font": if (!isHTMLFont(arg3)) break;
						case "b":
						case "big":
						case "blockquote":
						case "body":
					...
					if (current.namespaceURI === NAMESPACE.MATHML) adjustMathMLAttributes(arg3);
				...
				case 3:
					current = stack.top;
					if (value === "script" && current.namespaceURI === NAMESPACE.SVG && current.localName === "script") stack.pop();
					else {
		...
		htmlparser.testTokenizer = function(input, initialState, lastStartTag, charbychar) {
			...
			switch (initialState) {
				...
				case "RAWTEXT state":
					tokenizer = rawtext_state;
					break;
				case "PLAINTEXT state": tokenizer = plaintext_state;
			}
			if (lastStartTag) lasttagname = lastStartTag;
			insertToken = function(t, value, arg3, arg4) {
				flushText();
				switch (t) {
					case 1:
						if (tokens.length > 0 && tokens[tokens.length - 1][0] === "Character") tokens[tokens.length - 1][1] += value;
					...
					case 2:
						...
						tokens.push(token);
						break;
					case 3: tokens.push(["EndTag", value]);
				}
			};
			if (!charbychar) this.parse(input, true);
			else {
				for (var i = 0; i < input.length; i++) this.parse(input[i]);
				this.parse("", true);
			}
			return tokens;
		};
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/DOMImplementation.js
var require_DOMImplementation = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	DOMImplementation.prototype = {
		...
		createDocument: function createDocument(namespace, qualifiedName, doctype) {
			...
			if (namespace === utils.NAMESPACE.HTML) d._contentType = "application/xhtml+xml";
			else if (namespace === utils.NAMESPACE.SVG) d._contentType = "image/svg+xml";
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/Location.js
var require_Location = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	Location.prototype = Object.create(URLUtils.prototype, {
		...
		assign: { value: function(url) {
			var newurl = new URL(this._href).resolve(url);
			this._href = newurl;
		} },
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/NavigatorID.js
var require_NavigatorID = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/WindowTimers.js
var require_WindowTimers = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		setTimeout,
		clearTimeout,
		setInterval,
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/impl.js
var require_impl = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var utils = require_utils();
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/Window.js
...
//#endregion
//#region node_modules/@mixmark-io/domino/lib/index.js
var require_lib = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.createIncrementalHTMLParser = function() {
		...
		return {
			...
			write: function(s) {
				if (s.length > 0) parser.parse(s, false, function() {
					return true;
				});
			},
			/**
	...
	exports.createWindow = function(html, address) {
		...
		if (address !== void 0) document._address = address;
