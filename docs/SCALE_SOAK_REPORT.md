...
Run: `node scripts/stress-ui-multisize.mjs http://127.0.0.1:8080/`

*Filled after the Playwright soak on this revision.*

| Op | app-ready ms | wait ms | Budget | Result |
|----|--------------|---------|--------|--------|
| open (cold) | | | <30s progressive | |
| tree | | | <1s | |
| search | | | <1s | |
| graph | | | <1s | |
| new note | | | <1s | |
| switch notes | | | <1s | |
| editorTyped | | | must be true | |
| notes after create | | | **45001** exact | |
