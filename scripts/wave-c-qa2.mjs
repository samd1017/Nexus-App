...
await page.screenshot({ path: screenshotPath("wave-c-conflict.png") });
...
await mobile.screenshot({ path: screenshotPath("wave-c-mobile.png") });
...
fs.writeFileSync(screenshotPath("wave-c-qa2.json"), JSON.stringify(report, null, 2));
