...
async function runDesktop() {
  ...
  await page.screenshot({ path: screenshotPath("wave-c-settings.png") });
  ...
  await page.screenshot({ path: screenshotPath("wave-c-studio.png") });
  ...
  await page.screenshot({ path: screenshotPath("wave-c-resolved.png") });
  ...
  await page.screenshot({ path: screenshotPath("wave-c-pulse.png") });
  ...
  await page.screenshot({ path: screenshotPath("wave-c-banner.png") });
...
async function runMobile() {
  ...
  await page.screenshot({ path: screenshotPath("wave-c-mobile.png") });
...
fs.writeFileSync(
  screenshotPath("wave-c-final-qa.json"),
